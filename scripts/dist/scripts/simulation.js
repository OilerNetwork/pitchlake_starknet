...
async function main(environment, port) {
    ...
    const feeTokenFacade = new ERC20Facade("0x49d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7", provider);
    feeTokenFacade.erc20Contract.connect(devAccount);
    await feeTokenFacade.erc20Contract.transfer("0x0134f47366096198eb8f86e3ae6b075d399ca7abd918a56e01bb3b24963c2f75", BigInt(1000000000000000000));
    await feeTokenFacade.erc20Contract.transfer("0x01577908d02E0a3A6B243A149Eb91BB4514f3aAb948CFE63b2f8bb52397618D4", BigInt(1000000000000000000));
