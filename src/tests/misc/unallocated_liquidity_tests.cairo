...
//     // At this time, remaining liqudity was rolled to the next round (just initial deposit since
//     there is no payout and premiums were collected)
...
//     //@note Will include the premiums is unallocated and the locked deposit in allocated at this
//     stage let (lp_allocated, lp_unallocated) =
//     vault_facade.get_lp_balance_spread(liquidity_provider_1());
//     // Settle option round with no payout
...
//     // LP % of the round
//     // @note Check math is correct/precision is handled (goes for all instances of ratio
...
//     let bid_amount_user_1: u256 = ((params.total_options_available / 2) + 1) *
