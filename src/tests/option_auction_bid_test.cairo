...
fn test_bid_below_reserve_price() {
    ...
    set_contract_address(option_bidder_buyer_1());
    let success = vault_dispatcher.auction_place_bid(10 * vault_dispatcher.decimals().into()  , bid_below_reserve );
...
fn test_option_balance_per_bidder_after_auction_1() {
    ...
    let options_created_user_2_count: u256 = vault_dispatcher.option_balance_of(option_bidder_buyer_2());
    let options_created_user_3_count: u256 = vault_dispatcher.option_balance_of(option_bidder_buyer_3());
    let options_created_user_4_count: u256 = vault_dispatcher.option_balance_of(option_bidder_buyer_4());
...
fn test_option_balance_per_bidder_after_auction_2() {
    ...
    let  (option_round_id, mut option_params) : (u256, OptionRoundParams) = vault_dispatcher.start_new_option_round();
    ...
    let options_created_user_3_count: u256 = vault_dispatcher.option_balance_of(option_bidder_buyer_3());
    let options_created_user_4_count: u256 = vault_dispatcher.option_balance_of(option_bidder_buyer_4());
    let options_created_user_5_count: u256 = vault_dispatcher.option_balance_of(option_bidder_buyer_5());
    let options_created_user_6_count: u256 = vault_dispatcher.option_balance_of(option_bidder_buyer_6());
...
fn test_option_balance_per_bidder_after_auction_3() {
    ...
    let unused_bid_amount_user_3: u256 = vault_dispatcher.unused_bid_deposit_balance_of(option_bidder_buyer_3());
    ...
    assert( options_created_user_5_count == 0, 'options shd match');
    assert( options_created_user_6_count == 0, 'options shd match');
    assert( unused_bid_amount_user_3 == 27 * vault_dispatcher.decimals().into(), 'unused bid amount shd match');
