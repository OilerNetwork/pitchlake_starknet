...
fn test_round_start_auction_success_matt() {
    ...
    let (
        option_round_id, option_params, option_round_address
    ...
    let round_dispatcher: IOptionRoundDispatcher = IOptionRoundDispatcher {
        contract_address: option_round_address
    };
...
//     set_contract_address(liquidity_provider_1());
//     let lp_id: u256 = vault_dispatcher.open_liquidity_position(deposit_amount_wei);
//      let (option_round_id, option_params, _): (u256, OptionRoundParams, ContractAddress) = vault_dispatcher
//         .start_new_option_round();
...
//     round_dispatcher
//         .refund_unused_bid_deposit(option_bidder_buyer_1()); // should fail as auction has not ended
// }
...
//     round_dispatcher.auction_place_bid(bid_amount_user_1, bid_price_user_1);
//     round_dispatcher
//         .claim_option_payout(option_bidder_buyer_1()); // should fail as option has not settled
// }
