    ...
    loop {
        match rounds_to_run {
            ...
            _ => {
                ...
                let settlement_price = current_round.get_strike_price() + rounds_to_run.into();
...
// Test settling an option round increments the current round id
#[test]
#[available_gas(10000000)]
