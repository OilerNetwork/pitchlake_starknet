...
fn test_invalid_user_collection_of_payout_after_settle() {
    ...
    let claimed_payout_amount: u256 = vault_dispatcher
        .claim_option_payout(option_round_id, option_bidder_buyer_2());
    assert(
...
fn test_collection_of_premium_after_settle() {
    ...
    vault_dispatcher.settle_option_round();
    let claimed_payout_amount: u256 = vault_dispatcher
        .claim_option_payout(option_round_id, option_bidder_buyer_1());
    ...
    assert(
        claimable_premium_amount == vault_dispatcher.total_options_sold()
...
fn test_option_post_payout_collaterized_count_1() {
    ...
    set_contract_address(option_bidder_buyer_1());
    let claimed_payout: u256 = vault_dispatcher
        .claim_option_payout(option_round_id, option_bidder_buyer_1());
