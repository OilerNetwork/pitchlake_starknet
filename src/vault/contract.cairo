...
mod Vault {
    ...
    use pitch_lake::vault::interface::{
        ConstructorArgs, IVault, L1Data, L1DataCallbackReturn, RoundSettledReturn
    };
    ...
    impl VaultImpl of IVault<ContractState> {
        ...
        fn l1_data_processor_callback(
            ...
            if state == OptionRoundState::Running {
                ...
                L1DataCallbackReturn::RoundSettled(RoundSettledReturn { total_payout })
                ...
                L1DataCallbackReturn::FirstRoundInitialized
            }
        }
    ...
    impl InternalImpl of VaultInternalTrait {
        ...
        fn settle_round(ref self: ContractState, l1_data: L1Data) -> u256 {
            ...
            self.deploy_next_round(L1Data { twap, max_returns, reserve_price });
